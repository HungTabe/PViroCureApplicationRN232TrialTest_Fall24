...
public partial class ViroCureFal2024dbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PersonId).HasName("PK__Person__543848DF7825081D");
        ...
        {
            entity.HasKey(e => new { e.PersonId, e.VirusId }).HasName("PK__person_v__7BFA2E3F33CD5FE9");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__ViroCure__B9BE370FCAC3B126");

            entity.ToTable("ViroCureUser");

            entity.HasIndex(e => e.Email, "UQ__ViroCure__AB6E616487207F3C").IsUnique();
        ...
        {
            entity.HasKey(e => e.VirusId).HasName("PK__Virus__FC266E03ADF4281B");
